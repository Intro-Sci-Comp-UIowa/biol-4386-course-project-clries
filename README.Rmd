...
library(tidyverse)
risktol = read_tsv('/wdata/cries/career_proj/biol-4386-course-project-clries_backup/data/input_data/LDPred2/adhd-PGC-2019ancestry_adjusted_pgs.tsv')

jobdat = read_tsv('/wdata/cries/career_proj/biol-4386-course-project-clries_backup/data/input_data/ukb_job_data.tsv')
